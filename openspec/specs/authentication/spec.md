...
Defines how users authenticate to the Super 8 Studio Developer API via `login`/`logout`, including password and TOTP login, organization selection, session storage, and token verification.
